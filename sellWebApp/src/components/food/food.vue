    ...
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div class="price">
          ...
          v-show="food.oldPrice" class="old">
          ￥{{food.oldPrice}}</span>
        </div>
      ...
      <div class="info" v-show="food.name">
        ...
        <div class="no-info" v-show="!food.info">
          暂无商品信息</div>
      </div>
      <split v-show="food.name"></split>
      <div class="rating" v-show="food.name">
        ...
        <div class="rating-wrapper border-1px">
          <ul class="rating-items" v-show="food.ratings && food.ratings.length">
